    ...
    <script>
        function state() {
            ...
            if (a === 'Jaffna') {
                ...
                var array = ['JAFFNA ', 'VAVUNIYA', 'MANNAR', 'MULLAITHEEVU', 'KILINOCHCHI'];
					...
					<div class="card">
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerRegister.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="statevalue" id="states" onchange="state()" class="form-control border border-dark">
                                            ...
                                            <option value="GOA">NORTHRN</option>
                                ...
                                <div class="form-group row">
									<label for="account2" class="col-md-4 col-form-label text-md-right"><i class="fas fa-pencil-alt mr-2"></i><b>NIC NO.</b></label>
									<div class="col-md-6">
										<input type="text" id="account2" class="form-control border border-dark" name="pan" placeholder="Nic number" required>
									</div>
								</div>
